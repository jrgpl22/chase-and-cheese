...
if (visible) {
    ...
    // mouse score position (adjust these coordinates based on your banner design)
    var cat_score_x = x + 250;  // Offset from banner x
    var cat_score_y = current_y + 195;  // Use current_y for animation
    
    // Mouse score position
    var mouse_score_x = x + 250;
    var mouse_score_y = current_y + 223;  // Use current_y for animation
